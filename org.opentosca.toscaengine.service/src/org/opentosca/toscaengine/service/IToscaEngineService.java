...
public interface IToscaEngineService {
	 ...
	 *         hierarchy of the given Node Type
	 */
	 ...
	 * 
	 * @return references or null if ArtifacTemplate can not be found or hasn't
	 ...
	 * @param csarID
	 * @param artifactTemplate
	 * @return the Type of the specified ArtifactTemplate or null if
	 *         ArtifacTemplate can not be found
	 */
